...
function GetLongPollServer($group_id, $access_token) {
    $request_params = array('group_id' => $group_id, 'access_token' => $access_token, 'v' => '5.102');
    ...
    if (!isset($data->updates)) {
        ...
        while ($updates[$c]) {
		    ...
		    // TO DO DONATIONS
                ...
                if ($msg == "debug") {
                    vk_msg_send($peer_id, "@id" . $from_id . ",<br>from_id: " . $from_id . "<br>peer_id: " . $peer_id, '');
                }
                    ...
                    if (mysqli_num_rows($query) == 0) {
                        ...
                        if ($db['group_id'] == 0) {
                            ...
                            if ($db['user_condition'] == 'ready') {
                                ...
                                if (isset($updates[$c]->object->attachments)) {
